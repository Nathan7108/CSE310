...
|Web Apps                 | | TypeScript               | |
|Language – C++           | | Rust                     | |
|SQL Relational Databases + auth |x|Choose Your Own Adventure | |
...
|Did you completely populate the README.md template?                                                                 |x| |
...
I ended up taking what I learned here, and implemented it into our project in class, but in a more advanced way using Postgresql and storing live data coming from an API.
...
- What learning strategies worked well in this module?
  Youtube videos while I was walking between classes!
- What strategies (or lack of strategy) did not work well?
  Lack of time on my hands
